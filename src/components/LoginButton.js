...
getViewComponent = () => {
  if(this.props.iconSource){
    return (
      <View style={[this.props.buttonViewStyle, viewStyles.buttonViewStyle]}>
         ...
         />
         <Text style={[this.props.buttonTextStyle, {backgroundColor: 'transparent', marginLeft: 20}]}>{this.props.childeren}</Text>
      </View>
    );
  }
  //this (else) is for if the button shouldn't have an icon
    ...
    return(
      <View style={[this.props.buttonViewStyle, viewStyles.buttonViewStyle]}>
         <Text style={[this.props.buttonTextStyle, {backgroundColor: 'transparent'}]}>{this.props.childeren}</Text>
      </View>
